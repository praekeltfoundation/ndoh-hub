...
class FetchRapidproContactsTests(TestCase):
    ...
    def test_fetch_rapidpro_contacts_writes_csv(self):
        ...
        expected_headers = [
            ...
            "youngest_dob",
            "migration_key",
            "next_anc_appointment_date",
            "next_anc_appointment_text",
        ...
        expected_row = {
            ...
            "next_anc_appointment_date": fetch_rapidpro_contacts.get_field_data(
                contact
            )["next_anc_appointment_date"],
            "next_anc_appointment_text": fetch_rapidpro_contacts.get_field_data(
                contact
            )["next_anc_appointment_text"],
