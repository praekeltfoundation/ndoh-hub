...
class Command(BaseCommand):
    ...
    help = (
        "Submit babyloss to Jembi. This command is useful if for "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            default=None,
            help=(
                "UUIDs for babyloss` to fire manually. Use if finer "
    ...
    def handle(self, *args, **options):
        ...
        for change in changes.filter(
            action__in=("pmtct_loss_switch", "momconnect_loss_switch")
        ):
