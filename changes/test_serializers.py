...
class ReceiveWhatsAppEventSerializerTests(TestCase):
    def test_valid(self):
        serializer = ReceiveWhatsAppEventSerializer(
            data={
                "statuses": [
                    {
                        "errors": [
                            {
                                "code": 500,
                                "title": (
                                    "structure unavailable: Client could not display "
    ...
    def test_invalid_incorrect_status(self):
        ...
        self.assertEqual(
            serializer.errors,
            {"statuses": ["Ensure this field has at least 1 elements."]},
        )
    ...
    def test_invalid_missing_message_id(self):
        ...
        self.assertFalse(serializer.is_valid())
        self.assertEqual(
            serializer.errors, {"statuses": {0: {"id": ["This field is required."]}}}
        )


class ReceiveWhatsAppSystemEventSerializerTests(TestCase):
    def test_valid(self):
        serializer = ReceiveWhatsAppSystemEventSerializer(
            data={
                "events": [
                    {
                        "recipient_id": "27831112222",
    ...
    def test_missing_message_id(self):
        ...
        self.assertEqual(
            serializer.errors,
            {"events": {0: {"message_id": ["This field is required."]}}},
        )
