...
ADA_START_ASSESSMENT_URL = env.str("ADA_START_ASSESSMENT_URL", "https://sndony-int-dialog-api.ada-prod-za.prod.aws.ada.com")
X_ADA_CLIENTID = env.str("X_ADA_CLIENTID", "Gwbdsrhb43")
X_ADA_USERID = env.str("X_ADA_USERID", "12345")
