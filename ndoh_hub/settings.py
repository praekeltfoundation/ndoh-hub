...
ADA_START_ASSESSMENT_URL = env.str("ADA_START_ASSESSMENT_URL", None)
X_ADA_CLIENTID = env.str("X_ADA_CLIENTID", None)
...
ADA_EDC_STUDY_URL = env.str("ADA_EDC_STUDY_URL", None)
ADA_EDC_STUDY_ID = env.str("ADA_EDC_STUDY_ID", None)
ADA_EDC_REPORT_URL = env.str("ADA_EDC_REPORT_URL", None)
ADA_EDC_INSTITUTE_ID = env.str("ADA_EDC_INSTITUTE_ID", None)
...
MQR_WEEK_LIMIT_OFFSET = env.int("MQR_WEEK_LIMIT_OFFSET", 0)
...
WHATSAPP_TEMPLATE_SEND_TIMEOUT_HOURS = env.int("WHATSAPP_TEMPLATE_SEND_TIMEOUT_HOURS", 3)
