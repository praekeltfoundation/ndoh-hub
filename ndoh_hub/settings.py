...
# ADA
RAPIDPRO_URL = env.str("RAPIDPRO_URL", "https://rapidpro.qa.momconnect.co.za")
RAPIDPRO_TOKEN = env.str("RAPIDPRO_TOKEN", "feb9f6e223f126a42b4ab086baa1404b773cdc19")
...
X_ADA_USERID = env.str("X_ADA_USERID", None)
